...
import ch6.printer.MemberInfoPrinter;
import ch6.printer.MemberListPrinter;
import ch6.printer.VersionPrinter;
import ch6.service.ChangePasswordService;
import ch6.service.MemberRegisterService;
...
public class MainForSpring {
    ...
    private static void processChangeCommand(String[] args) {
        ...
        ChangePasswordService service = ctx.getBean(ChangePasswordService.class);
        try {
